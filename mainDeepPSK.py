...
def PipelineBPSK(words_number=10000, noise=True, sigma=1):
    """
    Function \n
...
class ConvNN(nn.Module):
    def __init__(self, input_size, output_size=1, sigma=1, hidden_size=64, num_filters=16):
...
if __name__ == "__main__" and "training" in sys.argv:
    ...
    X_train, Y_train = PipelineBPSK(1)
    m, n = X_train.shape
    input_size = n
    output_size = n
    hidden_size = 128
